...
const PrivacyPolicy = () => {
  return (
    <Box sx={{color: 'white', p: '50px'}}>
      <strong>Privacy Policy</strong>
      <p>This privacy policy is applicable to the Polipod app (hereinafter referred to as "Application") for mobile devices, which was developed by Omino Games AB (hereinafter referred to as "Service Provider") as a a Commercial service. This service is provided "AS IS".</p>
      <br/>
      <strong>What information does the Application obtain and how is it used?</strong>
      <br/>
      <strong>User Provided Information</strong>
      <p>The Application acquires the username and email address you supply when you register an account within the Application. Registration with the Service Provider is not mandatory. However, bear in mind that you might not be able to utilize some of the features offered by the Application unless you register with them.</p>
      <p>The Service Provider may also use the information you provided them to contact you from time to time to provide you with important information or for password resets. Your information will however not be used for marketing purposes. The username provided upon registration may be displayed for other users in certain features of the Application, including, but not limited to leaderbaords.</p>
      <br/>
      <strong>Automatically Collected Information</strong>
      <p>In addition, the Application may collect certain information automatically, including, but not limited to, the type of mobile device you use, your mobile devices unique device ID, the IP address of your mobile device, your mobile operating system, and information about the way you use the Application. The Service Provider intentionally collects usage data for the following purposes:</p>
      <ul>
        <li>
      ...
      <p>
        ...
        If you'd like the Service Provider to delete User Provided Data that you have provided via the Application, you can delete your account from within the Application, or contact the Service Provider at support@ominogames.com and we will respond in a reasonable time.
      ...
      <br/>
      <p>This privacy policy is effective as of 2024-03-16</p>
      <br/>
      ...
      <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at suport@ominogames.com.</p>
    </Box>
  );
}
